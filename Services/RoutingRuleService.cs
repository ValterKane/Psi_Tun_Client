    ...
    public static List<RoutingRule> GetDefaults()
    {
        return new List<RoutingRule>
        {
            ...
            new() { Description = "Battle.net напрямую", MatchType = RuleMatchType.ProcessName,
                Value = "Battle.net.exe", Action = RuleAction.Direct, IsDefault = true },
            new() { Description = "Blizzard Agent напрямую", MatchType = RuleMatchType.ProcessName,
                Value = "Agent.exe", Action = RuleAction.Direct, IsDefault = true },
